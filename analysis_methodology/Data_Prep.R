...
left_join(
data.frame(
  station=c("Lower Kingsbury (SR 207)","US 50 & Lake Parkway","US 50 & Carson St (Spooner Summit)","SR 28 & Lakeshore Dr (Incline)","Bigler","Brockway_Summit","Echo_Summit","F_Street","Midway","Sawmill"),
lat=c(38.967500,38.965484,39.121111,39.249357,38.935389,39.260764,38.815358,38.904321,38.952279,38.875694), 
lon=c(-119.923004,-119.937834,-119.824151,-119.985101,-119.977477,-120.071504,-120.027960,-119.999118,-119.949293,-120.005384)
), by="station") 
